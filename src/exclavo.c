...
if (argc != 3)
    ...
    fprintf(stderr," Uso: exclavo.out [nombre host servidor] [nickname]\n");
    exit(1);
    }
host=argv[1];
user=argv[2];
...
printf ("$$LISTA   devuelve la lista de los usuarios conectados.\n");
...
/* Ejecuta el padre el envio de mensajes. */

/* Registracion de nickname */
