 ...
 *
 **/
int verifyBAM(char *sFileGridConf, char *sFileGridIn)
{
    float *W;
    neuron *E;
    neuron *Y;
    ...
    removeMemory(W, EE, 0, 1); addMemory( W, EE, 2 ,0);
    evolveNet( W, E );

    showGridMemory(E);

    removeMemory(W, EE, 2, 0); addMemory( W, EE, 1, 2);
    evolveNet( W, E);
...
int main(int argc, char *argv[])
{
    ...
    printf ("Simulacion Red Hopfield 82 (v1.0) - 2003.\n");
