...
while (1)
	...
	if ((est[msg.id].x>22)&&(est[msg.id].x<31)&&((est[msg.id].y==12)||(est[msg.id].y==11)))
	    switch(est[msg.id].CONTROL)
		{
		case 0: puerta1=1;break;
		case 1: puerta2=1;break;
		case 2: puerta3=1;break;
		case 3: puerta4=1;break;
		default: break;
		}
	else
	    switch(est[msg.id].CONTROL)
		{
		case 0: puerta1=0;break;
		case 1: puerta2=0;break;
		case 2: puerta3=0;break;
		case 3: puerta4=0;break;
		default: break;
		}
