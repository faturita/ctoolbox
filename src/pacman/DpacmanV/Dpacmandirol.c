...
void onlinecontrol(int pipmsg[],int pip[],struct TipoEstado est[])
	...
	controltty(est[C_JUGADOR].SIMBOLO,est[C_JUGADOR].SIMBOLOB,est[C_JUGADOR].CONTROL,C_JUGADOR,est[C_JUGADOR].p_Modo,pipmsg,est[C_JUGADOR].pip,est[C_JUGADOR].sock);
